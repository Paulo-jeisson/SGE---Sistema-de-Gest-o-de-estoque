...
urlpatterns = [
    ...
    path('api/v1/outflows/', views.OutflowCreateListAPIView.as_view(), name='outflow_create_list'),
    path('api/v1/outflows/<int:pk>/', views.OutflowRetrieveAPIView.as_view(), name='outflow_detail_api'),
